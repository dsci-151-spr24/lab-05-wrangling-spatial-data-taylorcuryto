...
names(dn_lq_ak)
```
***There are `r nrow(dn_lq_ak)` observations. The names of the variables are address, city, state, zip, longitude, and latitude.
...
***Mitch Hedberg's joke about how there is always a Denny's next to La Quinta is most likely to hold true for Alaska because the mean distance they are away from eachother is 4.41 miles which is less than all the other states we examined.***
